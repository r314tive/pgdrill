# pgBackRest 2.58.0 / PostgreSQL 18.3 / Linux amd64
...
timestamp-PITR drills with pgBackRest 2.58.0 and PostgreSQL 18.3.
...
recorded the timestamp `2026-07-28T02:39:04.745627Z`, committed and archived
row 102 after the target, and proved that timestamp recovery contained exactly
101 rows.

Archive configuration checks, repository verification, native pgBackRest WAL
...
performance or RTO evidence. The same-host local filesystem repository does
not establish remote or object-storage compatibility. Encryption,
